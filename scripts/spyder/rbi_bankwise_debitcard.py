...
list_of_pages1 = ['Debit-Cards-by-Payments-Banks']
list_of_pages = [
    {
    "pg_name": "Debit-Cards-by-Payments-Banks",
    "row_range": [(1, 6), (60, 66)],
    "column_range": [(1, 2), (10, 10)],
    "month_to_fetch":"Dec",
    "term_to_look": "Payments Banks"
    },
    {
    "pg_name": "Debit-Cards-by-Foreign-Banks",
    "row_range": [(1, 6), (45, 58)],
    "column_range": [(1, 2), (10, 10)],
    "month_to_fetch": "Dec",
    ...
    {
    "pg_name": "Debit-Cards-by-Private-Sector-Banks",
    "row_range": [(1, 6), (23, 43)],
    "column_range": [(1, 2), (10, 10)],
    "month_to_fetch": "Dec",
    ...
    {
    "pg_name": "Debit-Cards-by-Public-Sector-Banks",
    "row_range": [(1, 6), (10, 21)],
    "column_range": [(1, 2), (10, 10)],
    "month_to_fetch": "Dec",
    ...
    {
    "pg_name": "Debit-Cards-by-Small-Finance-Banks",
    "row_range": [(1, 6), (67, 77)],
    "column_range": [(1, 2), (10, 10)],
    "month_to_fetch": "Dec",
    ...
    for each in list_of_pages:
        ...
        try:
            excel_to_gemini_context = utils.excel_to_gemini_context(
                file_name + ".xlsx",
                f"Extract the Data for {month_to_fetch} 2025 for Number of {term_to_look}.",
                sheet_name="Sheet1",
            ...
            prompt_to_format_new_array = f"""
                ...
                5. **Data Integrity**: Retain original formatting (decimals, Indian numbering commas like 89,26,358). Do not summarize or calculate anything.
            ...
            print(f"==================================================")
            print("clean_data_to_append_formatted: ", clean_data_to_append_formatted)
            ...
            if updated_table and (updated_table[0][-1] != formatted_month):
                if len(clean_data_to_append_formatted[0])==2:
                    ...
                    updated_table_manual = utils.update_arrayOfarray(original_csv_array, clean_data_to_append_formatted)
                    # print(f"==================================================")
